 ...
 * @date 2016/3/24 0024
 */
public class WebSellDetailActivity extends BaseWebActivity {
    ...
    private void initData(final double longitude, final double latitude) {
        ...
        String url = "file:///android_asset/sellDetail.html";
        ...
        wb_webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                TbLog.i("---WebSellDetailActivity:", url);
        ...
        wb_webview.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, final String message, final JsResult result) {
                TbLog.i("---WebSellDetailActivity:", url);
                TbLog.i("---WebSellDetailActivity:", message);

                //token改变重新登录
                if (message.contains("账号安全")) {
                    new AlertDialog.Builder(WebSellDetailActivity.this)
                            .setTitle("提示!")
                            .setMessage(message)
                            .setPositiveButton("确定",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            startActivity(new Intent(WebSellDetailActivity.this, LoginActivity.class));
