 ...
 */
public class WebOperateStateActivity extends BaseWebActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if(requestCode==REQUEST_CODE_ASK_LOCATION) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                // Permission Denied
                Toast.makeText(this, "无定位!!权限", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private void initData(final double longitude, final double latitude) {
        ...
        String url = Config.URL_COMM + "app/tranGoodsInfo/queryOperatingSurvey?token=" + token +
        ...
        wb_webview.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, final String message, final JsResult result) {
                ...
                if (message.contains("账号安全")) {
                    new AlertDialog.Builder(WebOperateStateActivity.this)
                            .setTitle("提示!")
                            .setMessage(message)
                            .setPositiveButton("确定",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            startActivity(new Intent(WebOperateStateActivity.this, LoginActivity.class));
...
//        //provider = LocationManager.GPS_PROVIDER;    //使用GPS
//
...
//        AbLogUtil.i("---WebGoodsManageActivity:", "定位工具:" + provider);
//
//        @SuppressWarnings("ResourceType")
//        Location location = locationManager.getLastKnownLocation(provider);     //获取位置
//        if (location != null) {
//            longitude = location.getLongitude();  //拿到经度
//            latitude = location.getLatitude();      //拿到纬度
//            AbLogUtil.i("---WebGoodsManageActivity:", "经度和纬度:" + longitude + ",," + latitude);
//        } else {
//            longitude = 0;
//            latitude = 0;
//            AbLogUtil.i("---WebGoodsManageActivity:", "经度和纬度: 没获得");
//            Utils.showToast(this, "没有可用的位置");
//        }
//    }
}
