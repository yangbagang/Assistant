 ...
 */
public class WebDataCenterActivity extends BaseWebActivity {
    ...
    private void initData(final double longitude, final double latitude) {
        ...
        wb_webview.loadUrl("file:///android_asset/dataOverview.html");
        ...
        wb_webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                TbLog.i("---WebDataCenterActivity:", url);
        ...
        wb_webview.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, final String message, final JsResult result) {
                TbLog.i("---WebDataCenterActivity:", url);
                TbLog.i("---WebDataCenterActivity:", message);

                //token改变重新登录
                if (message.contains("账号安全")) {
                    new AlertDialog.Builder(WebDataCenterActivity.this)
                            .setTitle("提示!")
                            .setMessage(message)
                            .setPositiveButton("确定",
                                    new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            startActivity(new Intent(WebDataCenterActivity.this, LoginActivity.class));
